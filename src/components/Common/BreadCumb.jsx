...
const BreadCumb = ({ Title, bgImage = "/assets/img/page_heading_1.jpg" }) => {
    return (
        <section 
            className="h-[380px] flex items-center justify-center bg-cover bg-center relative z-10"
            style={{ backgroundImage: `url(${bgImage})` }}
        >
            {/* Overlay */}
            <div className="absolute inset-0 bg-[#00172d]/80 -z-10"></div>

            <div className="container mx-auto px-4 text-center">
                <h1 className="text-white font-semibold text-5xl md:text-[64px] mb-4">{Title}</h1>
                <ol className="flex justify-center items-center gap-2 text-sm font-bold uppercase text-white m-0 p-0 list-none">
                    ...
                    <li className="text-orange-600">{Title}</li>
                </ol>
            </div>
        </section>
    );
