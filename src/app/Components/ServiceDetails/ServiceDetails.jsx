            ...
            <div className="container">
                ...
                <div className="col-lg-8">
                    ...
                    <div className="cs_service_details">
                        <Image src="/assets/img/service_details_2.webp" alt="img" width={746} height={427}   /> 
                        ...
                        <div className="col-lg-6">
                            <Image src="/assets/img/service_details_3.webp" alt="img" width={361} height={317}   /> 
                        </div>
                        <div className="col-lg-6">
                            <Image src="/assets/img/service_details_4.webp" alt="img" width={361} height={317}   /> 
                        </div>
                        </div>
